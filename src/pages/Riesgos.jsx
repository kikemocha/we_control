...
const Riesgos = () => {
    ...
    return <div className='card_option'>
            <RiesgosForm show={showPopup} onClose={handleClosePopup} fetchData={fetchData} messagePopUp={handleCloseMessagePopUp} actualRiesgos={data.activo} selectedYear={selectedYear}/>
            <div className='total_add'>
                <div className='flex'>
