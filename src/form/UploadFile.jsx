            ...
            {!selectedFile ? (
              <div className="flex items-center justify-center w-full h-full">
                ...
                <input
                  id="dropzone-file"
                  type="file"
                  className="file-input" // Cambiar de "hidden" a una clase visible (puedes estilizar si prefieres ocultarlo)
                  onChange={(e) => {
                  ...
                  style={{ display: 'none' }} // Esto lo oculta pero no impide su clicabilidad por la etiqueta <label>
                />
              </div>
            ) : previewUrl ? (
